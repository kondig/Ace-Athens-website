...
const Home = () => (
  <div ref={(section) => {this.head=section;}}>
    <Sticky enabled={true} top={40} bottomBoundary={1500} >
      <FontAwesome className='scrollArrow' onClick={() => scrollToComponent(this.About_Us, {offset: 0, align: 'top', duration: 2500})} name='chevron-down' data-hover='SCROLL DOWN' spin={false} size='2x' />
    </Sticky>
    <div className="mainpic"></div> 
    <div className='mainpic-divider'></div>
    <div className="site-page">
      <div className="about" id="About_Us" ref={(section) => {this.About_Us=section;}}>
      ...
      <div className="about_text" >
        <p> <strong> Η Εταιρεία </strong> <br/><br/>
            Η Ace Athens - Aesthetics Center εδρεύει στην Αθήνα και δραστηριοποιείται στην Ελλάδα,
            Κύπρο και Αραβικό Κόσμο. Συστεγάζεται δε στο Μαρούσι με το Κέντρο Καταδυτικής Ιατρικής,
            με το οποίο έχει στενή συνεργασία στο επίπεδο των ιατρικών εφαρμογών. Μία ομάδα πλαστικών
            χειρουργών συνεργάζεται καθημερινά με ιατρούς εξειδικευμένους στην Υπερβαρική Ιατρική,
            με στόχο την εκπόνηση πρωτοποριακών θεραπειών πάνω στην αντιγήρανση, συνδυάζοντας μεθόδους
            της πλαστικής χειρουργικής και του υπερβαρικού οξυγόνου. <br/><br/>
            Πυλώνες της καθημερινής ιατρικής πρακτικής και συνεργασίας είναι:
        </p>
        <ul>
          <li>Βαθειά γνώση του αντικειμένου μας</li>
    ...
    <div className="other" > </div>
      <section className="other_text">
       ...
       <br/><br/>
       <FontAwesome className='scrollArrowBack' onClick={() => scrollToComponent(this.head, {offset: -300, align: 'top', duration: 5500})} name='angle-up' data-hover='πίσω στο μενού' spin={false} size='2x' />
       <br/><br/>
      </section>
