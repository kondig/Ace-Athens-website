  ...
  <div className="pop_page">
    <div className="sub_flex">
      ...
      <div className="flexitem_text">
          Δεν είναι πάντα ξεκάθαρο πότε ένας άνθρωπος αποφασίζει για τον επαγγελματικό του προσανατολισμό και ποια είναι τα χαρακτηριστικά εκείνα που τον οδηγούν σε συγκεκριμένες επιλογές. Από τα μαθητικά μου όμως χρόνια στην Πάτρα την δεκαετία του 1970 και με την ευαισθητοποίησή μου από τις αναφορές που είχα σ’ ένα σχολείο πρωτοποριακό για την εποχή του, όπως ήταν το <b> Πειραματικό Σχολείο του Πανεπιστημίου Πατρών </b>, αγάπησα τον άνθρωπο, τον πολιτισμό και τις τέχνες και καταστάλαξα στον  προσανατολισμό μου για την Ιατρική από πολύ νωρίς. Σπουδάζοντας στην <b>Ιατρική Σχολή Αθηνών</b> από όπου και αποφοίτησα το 1987 ενίσχυσα τις πεποιθήσεις μου ότι η Ιατρική και ακόμη περισσότερο η Χειρουργική πέρα από επιστήμη ενέχει και χαρακτηριστικά άλλων τεχνών  όπως η  γλυπτική και η  ζωγραφική, η μουσική ή η λογοτεχνία. Η αγάπη μου για τη Χειρουργική αλλά και η εκμάθηση μουσικών οργάνων  ή η ενασχόλησή μου με τις τέχνες γενικότερα, μου ξεκαθάρισαν την ιδανικότερη για μένα επιλογή, αυτή της Πλαστικής Χειρουργικής, όπου διατηρεί σε αρμονία τόσο τη λειτουργική όσο και την αισθητική αποκατάσταση σε προβλήματα υγείας που αφορούν πάσχοντες ή και μη, συνανθρώπους μας. Το δέρμα, το μεγαλύτερο όργανο του ανθρώπινου σώματος, αποτελεί τον φραγμό του ανθρώπινου οργανισμού προς το εξωτερικό περιβάλλον και το αντικείμενο αντίληψης πολλών αισθήσεών μας όπως της όρασης ή της αφής κι έτσι η οποιαδήποτε παρέμβασή μας επάνω του, αφήνει ανεξίτηλα τα σημάδια της τόσο στον ίδιο όσο και στους γύρω.
      </div>
    </div>
    <div>
      <p>
        <b>Τον τίτλο της ειδικότητας της Πλαστικής Χειρουργικής</b> τον πήρα στην Ελλάδα κατόπιν επιτυχών εξετάσεων το 1998 και έκτοτε εργάζομαι ανελλιπώς ως Πλαστικός Χειρουργός στην Αθήνα, ως <b>επιμελητής στο Ογκολογικό Νοσοκομείο ΙΚΑ « Γ.Γεννηματάς»</b> από το 1998 έως το 2011 και ως <b>επιμελητής Α΄ στο «Γενικό Ογκολογικό Νοσοκομείο Κηφισιάς Αγ. Ανάργυροι»</b> από το 2011 έως και σήμερα, ενώ παράλληλα διατηρώ και <b>ιδιωτικό ιατρείο</b> . Όταν φυσικά αγαπάς αυτό που κάνεις, έχεις έναν παραπάνω λόγο να εξελίσσεις συνεχώς τον τομέα σου και τις γνώσεις σου πάνω στο αντικείμενο και γι’ αυτό τον λόγο έχω παρακολουθήσει και παρακολουθώ σειρά εκπαιδευτικών σεμιναρίων τόσο στην Ελλάδα όσο και στο εξωτερικό, ενώ την μετεκπαίδευσή μου την έκανα στο <b>Πανεπιστημιακό Νοσοκομείο της Γάνδης του Βελγίου</b>, με έμφαση πάνω στην αποκατάσταση του μαστού μετά από μαστεκτομή.

      </p>
      <p>
        Ακόμη και σήμερα μετά από όλα αυτά τα χρόνια άσκησης της πλαστικής χειρουργικής, θεωρώ ότι ο ολοκληρωμένος ιατρός θα πρέπει να έρχεται συνεχώς σε επαφή με την ιατρική στην ολότητά της και να αποκωδικοποιεί την έκφραση της ασθένειας και την αντιμετώπισή της ανεξάρτητα από φύλο, φυλή, εθνικότητα και ιδιαίτερα ατομικά χαρακτηριστικά. Έτσι είχα την τιμή να είμαι ένας από τους ιδρυτές του ελληνικού τμήματος των <b>Γιατρών Χωρίς Σύνορα</b>  το 1990 ( στην οποία διετέλεσα και Πρόεδρος από το 2000-2005) και να βιώσω τις διαφορετικές εκφράσεις του ανθρώπινου πόνου σε διάφορες αποστολές όπου και συμμετείχα όπως στο Ιράκ, στον πόλεμο της π. Γιουγκοσλαβίας, στην Παλαιστίνη, τη Ζάμπια, το Μαλάουι, το Μπουρούντι, τη Ρουάντα, το Ζαίρ, την Αιθιοπία,  την Γεωργία και το Πακιστάν-Αφγανιστάν. Η αντίδραση των ανθρώπων σε μια μεγάλη φυσική καταστροφή, στον πόλεμο, στην απόλυτη φτώχεια και την κατάρρευση των συστημάτων υγείας είναι η ίδια και είναι αυτή της αναζήτησης της αξιοπρέπειας, του αισθήματος της ασφάλειας και του σεβασμού στην ανθρώπινη ζωή.
        Η επί δεκαπέντε χρόνια συνεχής επαφή με τις αρχές και τις πρακτικές της ανθρωπιστικής δράσης με ώθησαν να κάνω τις μεταπτυχιακές μου σπουδές πάνω στην Ιατρική Καταστροφών και από το 2004 είμαι κάτοχος, μετά από εξετάσεις, του <b>Ευρωπαϊκού Μάστερ της Ιατρικής Καταστροφών</b> από τη συνεργασία δύο Πανεπιστημίων, αυτών των Βρυξελλών και του Πιεμόντ της Ιταλίας. Η εμπειρία μου αλλά και το θεωρητικό πλέον υπόβαθρο στον τομέα αυτό μου παρείχαν τα εφόδια, ώστε να είμαι εκπαιδευτής σε προγράμματα του ΙΝΕΠ και του ΕΚΔΔ σχετικά με ζητήματα πολιτικής προστασίας και ανθρωπιστικής ιατρικής, ενώ την τριετία 2011-2013, διετέλεσα επιστημονικά Υπεύθυνος της Ενότητας Ιατρικής Καταστροφών στο ΜΠΣ του ΕΚΠΑ « Διεθνής Ιατρική- Διαχείριση κρίσεων».
      </p>
      <p>
        <b>Το Πιστεύω μου</b> λοιπόν πάνω στην καθημερινή άσκηση της Ιατρικής Ειδικότητας είναι ότι η <b>Πλαστική Χειρουργική</b> είναι μία <b>Ύψιστη Τέχνη</b>, που συνδυάζει την Επιστημονική σκέψη και γνώση με την Καλλιτεχνική έκφραση της αρμονίας, αναλογίας και συμμετρίας στο ανθρώπινο σώμα, όπως αυτές έχουν περιγραφεί από τους πρώτους Πυθαγόρειους και τον «Κανόνα» του Πολύκλειτου έως τον άνθρωπο του Βιτρούβιου και τη μελέτη του Λεονάρντο Ντα Βίντσι. Στη σύγχρονη δε εφαρμογή της, θα πρέπει να διέπεται από αρχές όπως ο σεβασμός των ιστών, η τήρηση των αναλογιών του σώματος και η εφαρμογή τεχνικών που ακολουθούν  τις σύγχρονες διεθνείς βιβλιογραφικές αναφορές και τους σύγχρονους κανόνες ασφάλειας και ελέγχου των υλικών της ιατρο-βιοτεχνολογίας.
      </p>
    </div>
    <div>
          ...
          <p>
            Γρανικού 5, Μαρούσι, ΤΚ 15125 <br/>
          ...
          <ul>
            <b>Μικροχειρουργική τεχνική αποκατάστασης ελλειμμάτων μαλακών μορίων</b>
          ...
          <ol>
            ...
            <li>Εισηγητής σε μεταπτυχιακούς φοιτητές του μεταπτυχιακού προγράμματος « Διεθνής Ιατρική- Διαχείριση κρίσεων υγείας» - Τμήμα ΙΑΤΡΙΚΉς-Σχολή επιστημών υγείας Εθνικού και Καποδιστριακού Πανεπιστημίου Αθηνών 2010-2011 . 12 ώρες με θέματα ( 8/3/11, 15/3/11, 22/3/11 )
